...
namespace UsefulMeshCut
{
    ...
    public class MeshDataCache : MonoBehaviour
    {
        ...
        public void Initialize()
        {
            ...
            Debug.Log($"[UsefulMeshCut] Cache Completed. Cache Count: {Store.MeshCount}");
        }
        ...
        public bool TryGet(int meshId, out int2 vertexRange, out int2 triangleRange, out int submeshCount)
        {
            ...
            {
                Debug.LogError($"[UsefulMeshCut] IDの値が不正です {meshId}");
                vertexRange = default;
        ...
        public void Rebuild()
        {
            ...
            Debug.Log($"[UsefulMeshCut] メッシュストアを再構築しました。{before} → {Store.MeshCount} メッシュ");
        }
        ...
        public void Unload()
        {
            ...
            Debug.Log("[UsefulMeshCut] キャッシュを解放しました。");
        }
