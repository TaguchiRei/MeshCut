...
namespace BLINDED_AM_ME
{
    public class SampleMeshCut
    {
        ...
        private static SampleMeshCutSide left_side = new SampleMeshCutSide();
        private static SampleMeshCutSide right_side = new SampleMeshCutSide();
        ...
        public static GameObject[] Cut(GameObject victim, Vector3 anchorPoint, Vector3 normalDirection, Material capMaterial)
        {
            ...
            {
                // サブメッシュのインデックス数を取得
                triangles = victim_mesh.GetIndices(sub);
